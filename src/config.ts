...
export const site = {
	/** Your full name */
	name: "Omer Texerman",
	/** Short role/title shown in meta tags and homepage */
	title: "Full Stack Developer",
	/** Initials shown in the logo */
	initials: "OT",
	/** Homepage meta description */
	description:
		"Full Stack Developer — explore my interactive 3D desk to discover blog posts, projects, reading list, and photos.",
	/** Canonical site URL (used for OG tags, sitemap, RSS fallback) */
	url: "https://omer.texerman.com",
};

/**
 * Social links — leave a URL empty or remove the entry
 * to hide it from the footer.
 */
...
/**
 * Navigation items — these drive the desk scene objects, the content
 * header nav, and the accessible fallback nav. Remove an entry to
 * hide that section everywhere.
 */
export const navItems: {
	label: string;
	href: string;
	/** Description shown on the section page */
	description: string;
}[] = [
	{
		label: "Blog",
...
/** PostHog analytics config — leave key empty to disable */
